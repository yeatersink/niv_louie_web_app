...
def edit_extention():
    ...
    with ui.column().classes('w-full max-w-3xl mx-auto p-8 gap-8'):
        ...
        with ui.card().classes('w-full p-8'):
            ...
            ui.input(label="Language / Locale this add-on supports",
        ...
        def save_and_generate():
            ...
            ui.notify("Add-on updated.", type="positive")
